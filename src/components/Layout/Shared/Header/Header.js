    ...
    const themeToggler = () => {
        const currentTheme = theme === 'system' ? systemTheme : theme;
            ...
            if(currentTheme === "light"){
                return(
                    <Button onClick={()=>setTheme('dark')} className='bg-gray-900 hover:bg-gray-200 focus:outline-none'>
                ...
                return(
                    <Button onClick={()=>setTheme('light')} className='bg-gray-900 hover:bg-gray-200 focus:outline-none'>
                       <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-4">
